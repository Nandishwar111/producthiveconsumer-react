...
//rfce for this shortcut ,react functional component;
function Products() {

  //state management using useState() React hooks
  //ush - sfortcut for useState()
  const [products, setProducts] = useState([]);
  const [message, setMessage] = useState('');
  const [user, setUser] = useState('');

  //ueh shortcut - useEffect
  //React hook runs only once on first  render()
  /*
  ...
  const fetchProducts = () => {
    ...
    */
  return (
    <div>   <h1 className="text-warning">Products List</h1>
